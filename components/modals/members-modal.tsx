...
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuPortal, DropdownMenuSeparator, 
  DropdownMenuSub, DropdownMenuSubContent, DropdownMenuTrigger, DropdownMenuSubTrigger } from '@/components/ui/dropdown-menu'
const roleIconMap = {
  "GUEST": null,
      ...
      <DialogContent className='bg-white text-black overflow-hidden'>
        ...
        >
          { server?.members?.map((member) => (
            <article key={member.id} className='flex items-center gap-x-2 mb-6'>
